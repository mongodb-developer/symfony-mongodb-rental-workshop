...
<Tabs>
    <TabItem value="Mac">
    With MacOS, users will need to make sure to install pkg-config from Homebrew as mentioned [Homebrew documentations](https://formulae.brew.sh/formula/pkgconf) using the command  
